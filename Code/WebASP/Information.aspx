        ...
        <asp:Panel ID="Panel2" runat="server" Height="480px" BackColor="LightGray">
            ...
            <div style="background-color:LightBlue; padding:10px 10px 10px 10px; width:480px; margin-left:100px ">
                ...
                <div style="padding-top:10px;">
                    ...
                    <asp:Textbox ID="txbName" runat="server" Height="20px" Width="150px"></asp:Textbox>
                </div>
                <div style="padding-top:10px;">
                    <asp:Label ID="lbSurename" runat="server" Text="นามสกุล"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="lbSurenameSP" runat="server" Text=":"></asp:Label>&nbsp;&nbsp;
                    <asp:Textbox ID="txbSurename" runat="server" Height="20px" Width="150px"></asp:Textbox>
                </div>
                <div style="padding-top:10px;">
                ...
                <div style="padding-top:10px;">
                    ...
                    <asp:Label ID="lbEmailSP" runat="server" Text=":"></asp:Label>&nbsp;&nbsp;
                    <asp:Textbox ID="txbEmail" runat="server" Height="20px" Width="150px"></asp:Textbox>
                </div>
